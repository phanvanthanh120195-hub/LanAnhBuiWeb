...
const CourseContentDesignThinking = () => {
    ...
    const loadContent = async () => {
        ...
        if (data) {
            const filtered = (data as CourseContent[])
                .filter((c: any) => c.courseType === "designThinking")
    ...
    return (
        <section className="py-20 lg:py-28 bg-secondary/30">
            <div className="container mx-auto px-4">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-12">
                        <h2 className="section-title">Nội dung khóa học tư duy thiết kế</h2>
...
export default CourseContentDesignThinking;
